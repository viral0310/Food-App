...
class FruitsDetails extends StatefulWidget {
  const FruitsDetails({Key? key}) : super(key: key);
...
class _FruitsDetailsState extends State<FruitsDetails> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: foodController.selectRecord(nameAuthCollection: 'Fruits'),
                    ...
                    child: Column(
                      children: [
                        Obx(
                          () => GestureDetector(
                            onTap: () {
                              foodController.fruitlikes[index] =
                                  !foodController.fruitlikes[index];
                            ...
                            child: Align(
                                ...
                                child: (foodController.fruitlikes[index])
